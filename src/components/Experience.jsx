        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-xl sm:text-2xl font-bold mb-6 flex items-center gap-2 justify-center md:justify-start">                <Briefcase className="text-purple-400" />
                ...
                >
                  ...
                  <ul className="space-y-2">
                    {exp.highlights.map((highlight, idx) => (
                      <li key={idx} className="text-gray-400 text-sm sm:text-base flex items-start gap-2">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-xl sm:text-2xl font-bold mb-6 flex items-center gap-2 justify-center md:justify-start">                <GraduationCap className="text-purple-400" />
                Education
              </h3>
